...
modules.exports = function({validationVariabels}){
    function translateErrorCodes(errorCodes){
        ...
        const errorTranslations = {
            ...
            loginCredentialsNotMatch: "Username or password did not match any account, please try again",
